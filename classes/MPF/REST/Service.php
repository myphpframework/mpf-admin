...
abstract class Service {
    ...
    public static function setResponseCode($code) {
        ...
        switch ((int)$code) {
            case self::HTTPCODE_CONTINUE: $text = 'Continue'; break;
            case self::HTTPCODE_SWITCH_PROTOCOL: $text = 'Switching Protocols'; break;
            case self::HTTPCODE_OK: $text = 'OK'; break;
            case self::HTTPCODE_CREATED: $text = 'Created'; break;
            case self::HTTPCODE_ACCEPTED: $text = 'Accepted'; break;
            case self::HTTPCODE_NON_AUTH_INFO: $text = 'Non-Authoritative Information'; break;
            case self::HTTPCODE_NO_CONTENT: $text = 'No Content'; break;
            case self::HTTPCODE_RESET_CONTENT: $text = 'Reset Content'; break;
            case self::HTTPCODE_PARTIAL_CONTENT: $text = 'Partial Content'; break;
            case self::HTTPCODE_MULTIPLE_CHOICES: $text = 'Multiple Choices'; break;
            case self::HTTPCODE_MOVED_PERMANENTLY: $text = 'Moved Permanently'; break;
            case self::HTTPCODE_MOVED_TEMPORARILY: $text = 'Moved Temporarily'; break;
            case self::HTTPCODE_SEE_OTHER: $text = 'See Other'; break;
            case self::HTTPCODE_NOT_MODIFIED: $text = 'Not Modified'; break;
            case self::HTTPCODE_USE_PROXY: $text = 'Use Proxy'; break;
            case self::HTTPCODE_BAD_REQUEST: $text = 'Bad Request'; break;
            case self::HTTPCODE_UNAUTHORIZED: $text = 'Unauthorized'; break;
            case self::HTTPCODE_PAYMENT_REQUIRED: $text = 'Payment Required'; break;
            case self::HTTPCODE_FORBIDDEN: $text = 'Forbidden'; break;
            case self::HTTPCODE_NOT_FOUND: $text = 'Not Found'; break;
            case self::HTTPCODE_METHOD_NOT_ALLOWED: $text = 'Method Not Allowed'; break;
            case self::HTTPCODE_NOT_ACCEPTABLE: $text = 'Not Acceptable'; break;
            case self::HTTPCODE_PROXY_AUTH_REQUIRED: $text = 'Proxy Authentication Required'; break;
            case self::HTTPCODE_REQUEST_TIMED_OUT: $text = 'Request Time-out'; break;
            case self::HTTPCODE_CONFLICT: $text = 'Conflict'; break;
            case self::HTTPCODE_GONE: $text = 'Gone'; break;
            case self::HTTPCODE_LENGTH_REQUIRED: $text = 'Length Required'; break;
            case self::HTTPCODE_PRECONDITION_FAILED: $text = 'Precondition Failed'; break;
            case self::HTTPCODE_REQUEST_ENTITY_TOO_LARGE: $text = 'Request Entity Too Large'; break;
            case self::HTTPCODE_REQUEST_URI_TOO_LARGE: $text = 'Request-URI Too Large'; break;
            case self::HTTPCODE_UNSUPPORTED_MEDIA_TYPE: $text = 'Unsupported Media Type'; break;
            case self::HTTPCODE_INTERNAL_ERROR: $text = 'Internal Server Error'; break;
            case self::HTTPCODE_NOT_IMPLEMENTED: $text = 'Not Implemented'; break;
            case self::HTTPCODE_BAD_GATEWAY: $text = 'Bad Gateway'; break;
            case self::HTTPCODE_SERVICE_UNAVAILABLE: $text = 'Service Unavailable'; break;
            case self::HTTPCODE_GATEWAY_TIMED_OUT: $text = 'Gateway Time-out'; break;
            case self::HTTPCODE_HTTP_VERSION_NOT_SUPPORTED: $text = 'HTTP Version not supported'; break;
        }
